...
import 'package:practicefirebase/controllers/userController.dart';
import 'package:practicefirebase/pages/gdev/secondPage.dart';
import 'package:practicefirebase/pages/petra/state_management/second.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                int countVal = Get.find<CountController>().count;
                Get.find<UserController>().updateUser(
                    countVal); //using Get.find locates the controller that was created in 'init' in GetX
              },
            ),
            SizedBox(
              height: 100,
